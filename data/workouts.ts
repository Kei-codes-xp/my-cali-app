...
export const workouts: Record<string, WorkoutDay[]> = {
  beginner: [
    ...
    { day: "Tuesday", title: "Rest", type: "rest", exercises: [] },
    {
      day: "Wednesday",
      title: "Pull",
      type: "pull",
    ...
    { day: "Saturday", title: "Rest", type: "rest", exercises: [] },
    {
      day: "Sunday",
      title: "Cardio",
      type: "cardio",
  ...
  advanced: [
    {
      ...
      exercises: [
        ...
        { name: "One Arm Push-up Progression", sets: 3, reps: 5 },
        { name: "Ring Dips", sets: 4, reps: 8 },
        { name: "Pseudo Planche Push-ups", sets: 4, reps: 10 },
        { name: "Explosive Clap Push-ups", sets: 3, reps: 12 },
      ],
    },
    { day: "Tuesday", title: "Active Recovery", type: "rest", exercises: [] },
    {
      day: "Wednesday",
      title: "Pull Power",
      type: "pull",
